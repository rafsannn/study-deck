...
const SHORTCUT_GROUPS = [
  {
    ...
    icon: Tv,
    shortcuts: [
      { key: 'T', description: 'Toggle Cinema Theater Mode' },
      ...
      { key: 'Alt+← / Shift+P', description: 'Previous Chapter' },
      { key: 'Alt+→ / Shift+N', description: 'Next Chapter' },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: 'I', description: 'Toggle Mini-Player Mode' },
      { key: 'C', description: 'Toggle Video Chapters' },
